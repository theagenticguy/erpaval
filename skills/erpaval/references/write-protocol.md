...
When every section has real content and every success criterion is checked off, change the `Status:` line at the top of the packet from `IN PROGRESS` to `COMPLETE`.
</write_protocol>
