...
- Specs destined for AI coders (Kiro, Spec Kit, Claude Code with structured prompts).
...
Seeded from `templates/ears-spec-skeleton.md`. See `roles/ears-specifier.md` for the full authoring process.
