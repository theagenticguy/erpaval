...
| -------------------------------------------------------- | --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| "We need to run a discovery round"                       | `${CLAUDE_PLUGIN_ROOT}/skills/product-design-shared/references/double-diamond.md` | Gives the team a shared cadence — diverge, converge, diverge, converge.               |
| "We have a fuzzy problem and no obvious owner framework" | `${CLAUDE_PLUGIN_ROOT}/skills/product-design-shared/references/double-diamond.md` | The diamond structure surfaces the ownership question naturally.                      |
| "The team keeps converging too early"                    | `${CLAUDE_PLUGIN_ROOT}/skills/product-design-shared/references/double-diamond.md` | The divergent-then-convergent rhythm is literally why this framework exists.          |
...
- **The PRD consumes user stories.** See `templates/prd-template.md` section 5.1 (user-story table) and sections 9-10 (EARS-style NFRs and edge cases).
...
- `${CLAUDE_PLUGIN_ROOT}/skills/product-design-shared/references/double-diamond.md` — Design Council's four-stage divergent/convergent rhythm (Discover / Define / Develop / Deliver). Use as the round-level cadence.
