...
- **Role reference**: the matching file in `${CLAUDE_PLUGIN_ROOT}/skills/product-discovery/references/roles/`
...
- `${CLAUDE_PLUGIN_ROOT}/skills/product-discovery/references/frameworks/INDEX.md` (routing guide — discovery + spec decision tables, composition)
- Per-framework files in `${CLAUDE_PLUGIN_ROOT}/skills/product-discovery/references/frameworks/` — `double-diamond.md`, `how-might-we.md`, `jtbd-job-stories.md`, `user-stories-invest.md`, `ears.md`, `gherkin.md`
- `${CLAUDE_PLUGIN_ROOT}/skills/product-discovery/references/methodology/discovery-rounds.md` (six-phase methodology)
- `${CLAUDE_PLUGIN_ROOT}/skills/product-discovery/references/inference-heuristics.md` (PRD-route runs)
- `${CLAUDE_PLUGIN_ROOT}/skills/product-discovery/references/quality/prd.md` (PRD quality bar)
