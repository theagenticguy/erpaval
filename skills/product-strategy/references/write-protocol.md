...
Canonical write-protocol block for product-strategy work. Copied verbatim into every subagent prompt and every worklog-skeleton file. The output file on disk is the source of truth — partial work on disk survives timeouts and context loss; state held in working memory does not.
