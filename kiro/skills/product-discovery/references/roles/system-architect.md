...
- `${ERPAVAL_HOME}/skills/product-discovery/references/inference-heuristics.md` — scale / deployment / auth / data persistence heuristics that calibrate your NFR targets.
- `${ERPAVAL_HOME}/skills/product-discovery/references/quality/prd.md` — per-section quality bar.
