...
Run the consistency checks from `${ERPAVAL_HOME}/skills/product-discovery/references/quality/prd.md` (section titled "Cross-Section Consistency Checks"):
...
Walk every section against `${ERPAVAL_HOME}/skills/product-discovery/references/quality/prd.md`. Every section meets its minimum bar before you flip `Status: IN PROGRESS` → `Status: COMPLETE`.
