...
You reframe a fuzzy, solution-shaped, or emotionally loaded problem into 3-5 outcome-level "How Might We" questions. One foreground subagent per HMW run. Your output file is a `brainstorms/NNN-<slug>-requirements.md`, seeded from `${ERPAVAL_HOME}/skills/product-discovery/assets/hmw-skeleton.md` before you spawn.
...
- See `${ERPAVAL_HOME}/skills/product-discovery/references/frameworks/how-might-we.md` for the full framework reference.
