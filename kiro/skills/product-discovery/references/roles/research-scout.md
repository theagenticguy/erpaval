...
- `${ERPAVAL_HOME}/skills/product-discovery/references/inference-heuristics.md` — helps you pick competitors that match the inferred app type and scale.
- `${ERPAVAL_HOME}/skills/product-discovery/references/quality/prd.md` — sections 11 and 13 are yours; meet their minimum bar.
- `${ERPAVAL_HOME}/skills/product-discovery/assets/prd-template.md` — PRD skeleton; edit in place.
